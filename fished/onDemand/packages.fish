...
set emacs "gnutls,libxml2,emacs"

set hyperfine hyperfine

set wget "libuuid,wget"

set osspuuid ossp-uuid

set xmlstarlet "libxml2,libxslt,xmlstarlet"
